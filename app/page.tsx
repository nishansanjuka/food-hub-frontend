    ...
    <main className="w-full">
      ...
      <div className="flex justify-center w-full h-[100vh] absolute top-0">
        <div className=" mt-10 p-5 flex flex-col justify-center w-full pl-10">
          <h1 className=" text-4xl md:text-7xl 2xl:text-9xl max-w-7xl font-extrabold text-foreground">
            Savor the Flavor, Delivered to Your Doorstep!
          </h1>
          <p className=" md:mt-10 2xl:mt-20 text-lg md:text-xl 2xl:text-3xl max-w-7xl font-medium p-2 text-foreground">
